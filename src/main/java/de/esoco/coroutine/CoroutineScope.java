...
public class CoroutineScope extends CoroutineEnvironment {
     ...
     * {@link Coroutines#getDefaultContext() default context}.
     *
    ...
    public static <T> ScopeFuture<T> produce(
        Function<? super CoroutineScope, T> fGetResult, ScopeCode rCode) {
    ...
    public static <T> ScopeFuture<T> produce(CoroutineContext rContext,
        Function<? super CoroutineScope, T> fGetResult, ScopeCode rCode) {
        return new ScopeFuture<>(new CoroutineScope(rContext), fGetResult,
            rCode);
    }
    ...
    public static class ScopeFuture<T> implements Future<T> {
        ...
        private T getImpl() {
            if (eScopeCodeError != null) {
                throw new CoroutineScopeException(eScopeCodeError,
