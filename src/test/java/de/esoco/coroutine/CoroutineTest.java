...
public class CoroutineTest {
    ...
    public void testCondition() {
        launch(scope -> {
            ...
            assertBooleanInput("true", "false", scope,
                Coroutine.first(doIf((Boolean b) -> b, supply(() -> "true"))
                    .orElse(supply(() -> "false"))));
            ...
            assertBooleanInput("true", "false", scope,
                Coroutine.first(apply((Boolean b) -> b.toString()))
                    .then(apply(s -> Boolean.valueOf(s)))
                    .then(doIf((Boolean b) -> b, supply(() -> "true"))
                        .orElse(supply(() -> "false"))));
    ...
    /***************************************
     * Test of
     * {@link CoroutineScope#launch(de.esoco.coroutine.CoroutineScope.ScopeCode)}
     * with an empty scope that doesn't execute coroutines.
     */
    @Test
    ...
    public void testErrorHandling() {
        Coroutine<?, ?> ce = Coroutine.first(run(() -> {
    ...
    /***************************************
     * Test of
     * {@link CoroutineScope#produce(java.util.function.Function, de.esoco.coroutine.CoroutineScope.ScopeCode)}.
     */
    @Test
